...
_arr = [
	...
	[[[["CSLA_T72M_Des","CSLA_mrVG70","CSLA_mrRPG75","CSLA_mrSa58P","CSLA_mrUK59L"],[[0,0,0],[1.5,-5.5,0],[-1.5,-5.5,0],[2.5,-2.5,0],[-2.5,-2.5,0]],["Sergeant","Corporal","Private","Private","Private"]]
	],0.2],

	// configName CSLA_mrSqdBVP1
	[[[["CSLA_mrSgt","CSLA_mrRPG75","CSLA_mrSa58Pp","CSLA_mrVG70","CSLA_mrVG70","CSLA_mrUK59L","CSLA_mrUK59L","CSLA_BVP1_Des"],[[3,-4.5,0],[-3,-4.5,0],[3,1.5,0],[-3,1.5,0],[-1.5,-5.5,0],[3,-1.5,0],[-3,-1.5,0],[0,0,0]],["Sergeant","Corporal","Corporal","Private","Private","Private","Private","Corporal"]]
	],0.3],
	// configName CSLA_mrSqdOT64
	[[[["CSLA_mrSgt","CSLA_mrVG70","CSLA_mrVG70","CSLA_mrSa58Pp","CSLA_mrRPG7","CSLA_mrRPG75","CSLA_mrRPG7a","CSLA_mrUK59L","CSLA_mrUK59L","CSLA_OT64C_Des"],[[1,-5.5,0],[2.5,-2,0],[-2.5,-2,0],[2.5,1,0],[-2.5,1,0],[2.5,4.5,0],[-2.5,4.5,0],[1,-4,0],[-1,-4,0],[0,0,0]],["Sergeant","Corporal","Corporal","Private","Private","Private","Private","Private","Private","Corporal"]]
	],0.3],
	// configName CSLA_mrSqdOT62
	[[[["CSLA_mrSgt","CSLA_mrVG70","CSLA_mrVG70","CSLA_mrSa58Pp","CSLA_mrRPG7","CSLA_mrRPG75","CSLA_mrRPG7a","CSLA_mrUK59L","CSLA_mrUK59L","CSLA_OT62_Des"],[[1,-5.5,0],[2.5,-2,0],[-2.5,-2,0],[2.5,1,0],[-2.5,1,0],[2.5,4.5,0],[-2.5,4.5,0],[1,-4,0],[-1,-4,0],[0,0,0]],["Sergeant","Corporal","Corporal","Private","Private","Private","Private","Private","Private","Corporal"]]
	],0.2],
	// configName CSLA_mrADTeamOT65
	[[[["CSLA_mr9K32","CSLA_mr9K32","CSLA_mr9K32","CSLA_OT65A_Des"],[[2.5,1,0],[-2.5,-2,0],[2.5,-2,0],[0,0,0]],["Sergeant","Corporal","Private","Corporal"]]
	],0.2],
...
_arr = [
	...
	// configName CSLA_mrSqdOT64
	[[[["CSLA_mrSgt","CSLA_mrVG70","CSLA_mrVG70","CSLA_mrSa58Pp","CSLA_mrRPG7","CSLA_mrRPG75","CSLA_mrRPG7a","CSLA_mrUK59L","CSLA_mrUK59L","CSLA_OT64C"],[[1,-5.5,0],[2.5,-2,0],[-2.5,-2,0],[2.5,1,0],[-2.5,1,0],[2.5,4.5,0],[-2.5,4.5,0],[1,-4,0],[-1,-4,0],[0,0,0]],["Sergeant","Corporal","Corporal","Private","Private","Private","Private","Private","Private","Corporal"]]
	],0.3],
	// configName CSLA_mrSqdOT62
...
_arr = [
	...
	[[[["CSLA_rUK59a","CSLA_rUK59m","CSLA_rUK59m"],[[0,0,0],[2,-1,0],[-3,-2,0]],["Corporal","Private","Private"]]
	],0.01],
	// configName CSLA_rT21Team
	[[[["CSLA_rT21","CSLA_rT21a","CSLA_rT21a"],[[0,0,0],[2,-1,0],[-4,-2,0]],["Corporal","Private","Private"]]
	],0.01],
	// configName CSLA_r9P135MTeam
	[[[["CSLA_r9P135M","CSLA_r9M113","CSLA_r9M113"],[[0,0,0],[2,-1,0],[-4,-2,0]],["Corporal","Private","Private"]]
	],0.01],
