...
while{true}do{
	...
	// ограничим временно <5 созданных локально игроку патрулей
	...
	// ограничим временно <5 созданных локально игроку подкреплений
	if(_friendlyGroups+_enemyGroups < 5)then{
